...
import { auth, signInWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, signOut, onAuthStateChanged } from '../firebaseconfig/firebase';
        ...
        <div className="flex justify-center items-center h-screen bg-gradient-to-r from-black via-red-500 to-yellow-600">
            {user ? (
                ...
                <div className="login-form p-8 rounded-lg shadow-lg text-center max-w-md w-full bg-black">
                    ...
                    <div className="mt-4">
                        <button
                            className="py-2 px-4 bg-teal-600 text-white rounded-md cursor-pointer transition duration-300 ease-in-out hover:bg-teal-700"
                    ...
                    <div className="mt-4">
                        <Link to="/reset-password" className="text-sm text-teal-500  transition duration-300 ease-in-out hover:text-yellow-500">
                            Forgot Password?
                        </Link>
                    </div>
                </div>
