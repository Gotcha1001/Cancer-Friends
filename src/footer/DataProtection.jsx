            ...
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="p-6">
                    ...
                    <div className="bg-gray-100 p-4 mb-4 rounded-lg">
                        ...
                        <p>
                            Wesley Olivier, trading as Cancer Freedom Company, is dedicated to safeguarding the personal data of our users, particularly sensitive information concerning cancer patients. This policy outlines our commitment to data protection, ensuring compliance with the Protection of Personal Information Act (POPIA) and other applicable legislation.
                        </p>
                    </div>
                    ...
                    <div className="bg-gray-100 p-4 mb-4 rounded-lg">
                        ...
                        <ul className="list-disc list-inside">
                            <li>Enabling communication and interaction among cancer patients.</li>
                    ...
                    <div className="bg-gray-100 p-4 mb-4 rounded-lg">
                        ...
                        <ul className="list-disc list-inside">
                            ...
                            <li>Purpose Limitation: Personal data is collected for specified, explicit, and legitimate purposes related to supporting cancer patients.</li>
                    ...
                    <div className="bg-gray-100 p-4 mb-4 rounded-lg">
                        ...
                        <p>
                            <strong>Data Controller:</strong> Wesley Olivier is responsible for overseeing compliance with this policy and applicable data protection laws.<br />
                            <strong>Data Processor:</strong> All employees and contractors processing personal data on behalf of Cancer Freedom Company must comply with this policy and relevant data protection laws.
                        </p>
                    </div>
                    ...
                    <div className="bg-gray-100 p-4 mb-4 rounded-lg">
                        ...
                        <p>
                            For questions regarding this policy or to exercise your data protection rights, please contact our Information Officer at <a href="mailto:info@cancerfreedom.com">info@cancerfreedom.com</a>.
                        </p>
                    </div>
                </div>
            </div>
