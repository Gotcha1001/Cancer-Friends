      ...
      <div className="mx-auto max-w-4xl overflow-hidden rounded-lg bg-white shadow-lg">
        <div className="p-6">
          ...
          <div className="mb-4 rounded-lg bg-gray-100 p-4">
            ...
            <p>
              Wesley Olivier, trading as Cancer Freedom Company, is dedicated to
              safeguarding the personal data of our users, particularly
              sensitive information concerning cancer patients. This policy
              outlines our commitment to data protection, ensuring compliance
          ...
          <div className="mb-4 rounded-lg bg-gray-100 p-4">
            ...
            <ul className="list-inside list-disc">
              <li>
                Enabling communication and interaction among cancer patients.
              </li>
              <li>
              ...
              <li>
                Improving our platform’s functionality and user experience.
              </li>
              <li>
                Ensuring compliance with legal obligations and responding
                effectively to inquiries and complaints.
              </li>
            </ul>
          </div>
          ...
          <div className="mb-4 rounded-lg bg-gray-100 p-4">
            ...
            <ul className="list-inside list-disc">
              <li>
                Lawfulness, Fairness, and Transparency: Data is processed with
                user consent and in a transparent manner.
              </li>
              <li>
                Purpose Limitation: Personal data is collected for specified,
                explicit, and legitimate purposes related to supporting cancer
                patients.
              </li>
              <li>
                Data Minimization: We collect only the minimum amount of
                personal data necessary for our purposes.
              </li>
              <li>
                Accuracy: Users are encouraged to keep their information
              ...
              <li>
                Integrity and Confidentiality: We implement appropriate
                technical and organizational measures to ensure the security and
          ...
          <div className="mb-4 rounded-lg bg-gray-100 p-4">
            ...
            <p>
              ...
              processing personal data on behalf of Cancer Freedom Company must
          ...
          <div className="mb-4 rounded-lg bg-gray-100 p-4">
            ...
            <p>
              ...
              <a href="mailto:info@cancerfreedom.com">info@cancerfreedom.com</a>
              .
            </p>
          </div>
        </div>
